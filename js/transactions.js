...
function getHistory() {
    ...
    request.onload = function () {
        ...
        xhr.open("GET", "http://3.83.91.13:3500/web_service_transactions/user_id/" + userID, true);
...
function delReview(e) {
    ...
    xhr.open("DELETE", "http://3.83.91.13:3500/web_service_transactions/transaction_id/" + transactionID, true);
    xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhr.send();
}
