...
function getSeatInfo() {
    ...
    request.open("GET", "http://3.83.91.13:3500/web_service_transactions/movie_id/" + movieID + "/date/" + histDate + "/time/" + histTime, false);
...
function payment() {
    ...
    request.onload = function () {
        ...
        virtualAccountRequest.open("POST", "http://3.83.91.13:8080/web_service_bank_pro/services/GetVirtualNumber?wsdl", true);
        ...
        virtualAccountRequest.onload = function () {
            ...
            if (status === "200") {
                ...
                xhr1.open("POST", "http://3.83.91.13:3500/web_service_transactions", true);
...
function closePayment(transactionID, startTime) {
    ...
    request.onload = function () {
        ...
        checkTransactionRequest.open("POST", "http://3.83.91.13:8080/web_service_bank_pro/services/CheckTransactions?wsdl", true);
    ...
    for (i = 0; i < targetAccount.length; i++) {
        if (targetAccount[i].innerHTML == accountNumber) {
            ...
            if (time - startTime <= 120000) {
                ...
                xhr.open("PUT", "http://3.83.91.13:3500/web_service_transactions", true);
