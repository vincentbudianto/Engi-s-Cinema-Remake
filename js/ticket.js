...
function getSeatInfo() {
    ...
    request.open("GET", "http://3.85.125.42:3500/web_service_transactions/movie_id/" + movieID + "/date/" + histDate + "/time/" + histTime, false);
...
function payment() {
    ...
    request.onload = function () {
        ...
        virtualAccountRequest.open("POST", "http://3.85.125.42:8080/web_service_bank_pro/services/GetVirtualNumber?wsdl", true);
        ...
        virtualAccountRequest.onload = function () {
            ...
            if (status === "200") {
                ...
                xhr1.open("POST", "http://3.85.125.42:3500/web_service_transactions", true);
